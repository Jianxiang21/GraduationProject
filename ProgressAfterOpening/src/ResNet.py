...
# 超参数设置
INPUT_DIM = 118
OUTPUT_DIM = 59  # 根据非零列动态调整,poly=130,lin=59
...
def load_data(X, y, test_ratio=0.2):
    ...
    # 保存预处理参数
    np.savez('resnet_preprocess_lin.npz',
             mean=mean,
             std=std,
...
class ResNetPredictor:
    def __init__(self, model_path='best_resnet_model.pth'):
        # 加载预处理参数
        params = np.load('resnet_preprocess_lin.npz')
