...
BATCH_SIZE = 64
EPOCHS = 50
SAVE_NAME = 'model/poly_resnet_aug.pt'
PREPROCESS_FILE = 'model_data/poly_resnet_preprocess_aug.npz'
...
def main_train(Pd_path, data_path):
    ...
    plt.savefig('poly_loss_curve_54.png', dpi=300)
    plt.show()
...
if __name__ == '__main__':
    Pd_file = 'train_data/Pd_aug.pt'
    data_file = 'train_data/poly_result_aug.pt'
