...
BATCH_SIZE = 64
EPOCHS = 100
SAVE_NAME = 'model/poly_resnet_model_mu_100epoch.pt'
PREPROCESS_FILE = 'model_data/poly_resnet_preprocess_mu.npz'
IMG_PATH = 'poly_loss_curve_mu_100epoch.png'
...
def load_data_with_zero_mask(Pd_path, data_path, test_ratio=0.2):
    ...
    y = torch.load(data_path).numpy()[:,55:] / 10000
    y[np.abs(y) < 1e-5] = 0
